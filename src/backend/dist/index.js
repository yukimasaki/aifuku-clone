...
const createPageLabels = (page, pageCount, pageRange, baseUrl, perPage) => {
    ...
    if (pageCount <= 4) {
        ...
        duplicatedValues.push({ dupeCheckLabel: 'rightDot', value: '...', url: '', active: false }, { dupeCheckLabel: lastPage, value: lastPage, url: `${baseUrl}/?page=${lastPage}&perPage=${perPage}`, active: false }, { dupeCheckLabel: 'Next', value: 'Next', url: `${baseUrl}/?page=${page + 1}&perPage=${perPage}`, active: false });
    }
    else if (page === lastPage) {
        duplicatedValues.push({ dupeCheckLabel: 'Prev', value: 'Prev', url: `${baseUrl}/?page=${page - 1}&perPage=${perPage}`, active: false }, { dupeCheckLabel: firstPage, value: firstPage, url: `${baseUrl}/?page=${firstPage}&perPage=${perPage}`, active: false }, { dupeCheckLabel: 'leftDot', value: '...', url: '', active: false });
        Array.from({ length: 3 }, (_, index) => {
        ...
        isContinuous.forEach((isContinuous, index) => {
            if (index === 0) {
                ...
                if (isContinuous) {
                    leftPageLabels.push({ dupeCheckLabel: 'Prev', value: 'Prev', url: `${baseUrl}/?page=${page - 1}&perPage=${perPage}`, active: false });
                    ...
                    leftPageLabels.push({ dupeCheckLabel: 'Prev', value: 'Prev', url: `${baseUrl}/?page=${page - 1}&perPage=${perPage}`, active: false }, { dupeCheckLabel: firstPage, value: firstPage, url: `${baseUrl}/?page=${firstPage}&perPage=${perPage}`, active: false }, { dupeCheckLabel: 'leftDot', value: '...', url: '', active: false });
                    Array.from({ length: 3 }, (_, index) => {
                        const currentPage = index + page - pageRange;
                        leftPageLabels.push({
                            dupeCheckLabel: currentPage,
                ...
                if (isContinuous) {
                    ...
                    rightPageLabels.push({ dupeCheckLabel: 'Next', value: 'Next', url: `${baseUrl}/?page=${page + 1}&perPage=${perPage}`, active: false });
                }
                else {
                    Array.from({ length: 3 }, (_, index) => {
                        const currentPage = index + page;
                    ...
                    rightPageLabels.push({ dupeCheckLabel: 'rightDot', value: '...', url: '', active: false }, { dupeCheckLabel: pageCount, value: pageCount, url: `${baseUrl}/?page=${pageCount}&perPage=${perPage}`, active: false }, { dupeCheckLabel: 'Next', value: 'Next', url: `${baseUrl}/?page=${page + 1}&perPage=${perPage}`, active: false });
                }
